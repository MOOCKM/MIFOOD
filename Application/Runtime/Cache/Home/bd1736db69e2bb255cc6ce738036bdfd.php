			 ...
			 <!-- Brand and toggle get grouped for better mobile display -->
			  <div class="navbar-header nav_2">
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				...
				<?php if(is_array($category)): foreach($category as $key=>$v): ?><li><a href="/MIFOOD2/index.php/Home/Index/classify/category_id/<?php echo ($v['category_id']); ?>"><?php echo ($v["category_name"]); ?></a></li><?php endforeach; endif; ?>
...
<div id='ajaxpage1'>
<div class='page1' style='display:none;'><a href="<?php echo U('page1',array('p'=>1));?>" title="">自动点击执行AJAX请求显示第一页内容</a></div> 
</div>				
				<?php if(is_array($shop)): foreach($shop as $key=>$shop): ?><a href="/MIFOOD2/index.php/Home/Index/details/shop_id/<?php echo ($shop['shop_id']); ?>">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<a href="details.html"><img title=" " alt=" " src="<?php echo ($shop['shop_img']); ?>" width="180" height="140"/></a>		
...
//这是分页中各个分页的AJAX请求
$(function(){
   $('#ajaxpage1').on('click','.page1 a',function () { 
      $.ajax({
      type: "GET",
      url:$(this).attr('href'), //取得分页a标签链接地址，正好是要提交的控制器和传参：Index/ajaxPage/p/1
      success:function(data){
         $('#ajaxpage1').html(data); //将分页控制器输出的模版加载到容器中
      }
    });
